...
export const ISSUE_CODE_RULES: Readonly<Record<string, string>> = {
  ...
  // Checks of the QC on the render (qc/report.ts) and of the Remotion render (fonts).
  'media.upscale': 'TECH-09',
  'render.format': 'TECH-07',
  'render.black': 'TECH-03',
  'render.frozen': 'RHY-03',
  'render.fonts': 'TECH-04',
  'audio.voice': 'TECH-01',
  'audio.silence': 'SIL-04',
  'audio.gap': 'TECH-08',
  'audio.clipping': 'TECH-05',
  'audio.truePeak': 'TECH-05',
  'rights.attributions': 'SRC-03',
  'rights.synthetic': 'SRC-04',
  'mix.loudness': 'MUS-09',
  'mix.truePeak': 'MUS-09',
  'voice.loudness': 'MUS-01',
  'voice.truePeak': 'MUS-01',
