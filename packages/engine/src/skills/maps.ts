...
const mapSkill = (init: Omit<SkillDefinition, 'category' | 'compatibleShotTypes' | 'requires' | 'version' | 'parameters' | 'events' | 'fallback' | 'controlsCamera' | 'defaultDuration' | 'family' | 'implementation'> & Partial<SkillDefinition>) =>
