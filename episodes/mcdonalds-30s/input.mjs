...
const input = {
  ...
  script: [
    ...
    { kind: 'text', text: 'Over 60% of its revenue comes from franchisees.' },
    { kind: 'text', text: 'The annual report says it plainly: franchisees pay rent and royalties.' },
    {
      kind: 'text',
      text: 'And rent keeps growing: $9.8 billion in 2023.',
      hints: { chart: { kind: 'barChart', labels: ['2019', '2023'], values: [7.5, 9.8], unit: 'B$', title: 'Rent paid by franchisees', source: "McDonald's Form 10-K 2019 and 2023" } },
    },
    ...
    { kind: 'text', text: 'They own the land under more than half of them.', hints: { intent: 'revelation' } },
